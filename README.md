...
After organizing the data, run <a href='https://github.com/asvonavnsnvononaon/AutoMT/blob/main/TrainADS.py' target='_blank'>main.py</a>.<br> which includes the following steps:<br>
